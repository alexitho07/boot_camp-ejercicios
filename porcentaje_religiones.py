...
Rect(0,0,400,400,relleno=gradiente('varillaDorada','nebulosaRosa'))
...
Circle(130,240,120)
Arc(130,240,240,240,0,anguloDeBarrido1,fill="Ladrillo")
Arc(130,240,240,240,108,anguloDeBarrido2,fill="oro")
Arc(130,240,240,240,197,anguloDeBarrido3,fill="verde")
Arc(130,240,240,240,253,anguloDeBarrido4,fill="verdePalido")
Arc(130,240,240,240,277,anguloDeBarrido5,fill="azulOscuro")
Arc(130,240,240,240,295,anguloDeBarrido6,fill="indigo")
Arc(130,240,240,240,299,anguloDeBarrido7,fill="granate")

Rect(260,40,10,10,fill="Ladrillo")
Rect(260,60,10,10,fill="oro")
Rect(260,80,10,10,fill="verde")
Rect(260,100,10,10,fill="verdePalido")
Rect(260,20,10,10,fill="azulOscuro")
Rect(260,120,10,10,fill="Indigo")
Rect(260,140,10,10,fill="granate")
